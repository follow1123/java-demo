...
public class Message {
    ...
    public static Message fromObj(Object o) {
        return fromString(o.toString());
    }

    public String getToken() {
        return nullToEmpty(datagrams[0]);
    }
    ...
    public String getSerialNum() {
        return nullToEmpty(datagrams[1]);
    }

    public void setSerialNum(String serialNum) {
        datagrams[1] = serialNum;
    }

    public String getMsgType() {
        return nullToEmpty(datagrams[2]);
    }
    ...
    public String getBody() {
        return nullToEmpty(datagrams[3]);
    }
    ...
    public byte[] encodeBytes() {
        return encodeDatagram().getBytes();
    }
